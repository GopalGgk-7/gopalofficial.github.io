...
function loadSiteHeader() {
	...
	preload.loadFile("assets/img/ui/logo/tf-white.svg");
	preload.loadFile("assets/img/figures/tinified/who-figures.png");
	preload.loadFile("assets/img/figures/tinified/what-figures-jonny.png");
	preload.loadFile("assets/img/figures/tinified/work-figures.png");
	preload.loadFile("assets/img/figures/tinified/footer-rock.png");
	preloaderLoop();
}
//function loadSiteHeader() {
//	siteLoading = true;
